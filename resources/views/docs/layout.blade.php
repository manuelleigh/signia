        ...
        <aside id="docs-sidebar" class="fixed bottom-0 left-0 top-16 z-40 w-72 -translate-x-full overflow-y-auto border-r border-slate-200 bg-slate-50 px-4 py-6 transition-transform lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] lg:w-auto lg:translate-x-0">
            ...
            <nav aria-label="Navegación de documentación" class="space-y-7">
                ...
                <div>
                    ...
                    <a href="{{ route('docs.authentication') }}" aria-current="page" class="mt-2 flex items-center gap-2 rounded-lg bg-slate-900 px-3 py-2.5 text-sm font-semibold text-white shadow-sm">
                        <span class="rounded bg-emerald-400/15 px-1.5 py-0.5 font-mono text-[11px] text-emerald-300">POST</span>
                        Obtener token
                    </a>
                </div>
                <div>
                    <p class="px-3 text-xs font-bold uppercase tracking-wider text-slate-400">Comprobantes</p>
                    <span class="mt-2 flex items-center justify-between rounded-lg px-3 py-2 text-sm text-slate-400">Emitir comprobante <span class="text-[10px] font-bold uppercase">Próximo</span></span>
