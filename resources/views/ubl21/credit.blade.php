...
<CreditNote xmlns=""urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2""
    ...
    <cac:DiscrepancyResponse>
        ...
        <cbc:ResponseCode>{{ $document['note']['note_credit_type_id'] ?? '01' }}</cbc:ResponseCode>
        <cbc:Description><![CDATA[{{ $document['note']['note_description'] ?? 'Anulacion de la operacion' }}]]></cbc:Description>
    </cac:DiscrepancyResponse>
    ...
    <cac:CreditNoteLine>
        ...
        <cbc:CreditedQuantity unitCode="{{ $row['unit_type_id'] ?? 'NIU' }}">{{ $row['quantity'] }}</cbc:CreditedQuantity>
